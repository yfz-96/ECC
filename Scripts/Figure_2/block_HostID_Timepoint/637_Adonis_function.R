...
sample_metadata_function_file <- "../../../data/637/function/637_function_metadata.tsv" 

dm_func_rpca_file <- "../../../data/637/function/637_all_ko_rpca/rpca.distance_matrix/distance-matrix.tsv"

outpath <- "../../../Results/Figure_2/637_function_dist_block_hostid_timepoint.PerMANOVA_out/"
dir.create(outpath)
