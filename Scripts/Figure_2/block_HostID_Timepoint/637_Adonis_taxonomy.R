...
sample_metadata_taxonomy_file <- "../../../data/637/taxonomy/637_taxonomy_metadata.tsv" 

dm_taxo_phylo_rpca_file <- "../../../data/637/taxonomy/637_all_asv_phylo_rpca/phylo_rpca.distance_matrix/distance-matrix.tsv"

outpath <- "../../../Results/Figure_2/637_taxonomy_dist_block_hostid_timepoint.PerMANOVA_out/"
dir.create(outpath)
