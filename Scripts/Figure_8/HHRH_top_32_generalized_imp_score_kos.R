...
imp_score <- read.table("../../Results/Figure_6/MiC/function_HHRH_models_Position_crossRF_out/all_Taxon_OTU.RF_imps.tsv", 
                        sep = "\t", header = T)
...
glogfc <- read.table("../../Results/Figure_8/generalized_log2_fold_change_of_kos/generalized_logfc_by_datasets.txt",
...
ggsave(filename="../../Results/Figure_8/generalized_log2_fold_change_of_kos/HHRH_top32_glogfc.pdf", plot=glogfc_plot, width=15, height=10)
