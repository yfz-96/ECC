...
ggsave(filename=paste(outpath, "/Fig3G_637_all_ko_rpca_PC1_position_grouphost.pdf", sep=""), plot=plot, width=10, height=3.5)
...
ggsave(filename=paste(outpath, "/Fig3H_1867_all_ko_rpca_PC1_position_grouphost.pdf", sep=""), plot=plot, width=10, height=3.5)
